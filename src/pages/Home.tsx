...
function Home() {
  return (
    <>
      ...
      <p className="mt-5 text-xl text-left lg:text-5xl lg:w-[50%] lg:mt-10 "> 
      ...
      <h2 className="text-xl text-left lg:text-2xl">(002)</h2>
        ...
        <button className="py-5 mt-16 px-7 border rounded-full w-[300px]">ajalaferanmi123@gmail.com</button>
        </div>
