               ...
               <div className="flex flex-col gap-7 mt-14 text-zinc-100 text-sm lg:text-base " >
                ...
                <div className="flex justify-between items-center w-full ">
                    <div className="w-full md:w-3/5 flex flex-col gap-2 ">
                        ...
                        <p className="text-xs md:text-sm ">Full Stack Engineer focused on building products with extra attention to details</p>
                        ...
                        <div className="w-full flex gap-2 flex-wrap py-1 md:py-3">
                            ...
                            <a href="https://twitter.com/sijiramakun" target="_blank">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs md:text-base tracking-wide text-zinc-100">As a dedicated Full Stack Engineer, my passion lies in building technology that positively impacts and aids people. I am consistently excited about the opportunity to create, innovate, and contribute to meaningful solutions. Whether it is bringing ideas to life or leading collaborative efforts.</p>
                </div>
